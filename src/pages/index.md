...
<div class="page-title">
    <div class="title">
        <!-- <img class="nips-logo" src="figures/nl4optlogo.jpg" height="200"> -->
        <img src="../images/nl4optlogo.jpg" alt="NL4Opt Logo" height="200">
    </div>
...
<nav class="navbar">
  <div class="dropdown" style="float:right">
    <button class="dropbtn" onclick="toggleDropdown()">Past competitions <i class="arrow down"></i></button>
    <div class="dropdown-content" id="myDropdown">
      <a href="https://nl4opt.github.io/2022/">NL4opt Competition 2022</a>
    </div>
  </div>s
</nav>
